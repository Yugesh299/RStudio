---
title: "Repercussions of Stroms in USA "
author: "Yugesh Keluskar"
date: "9/08/2020"
---


## 1: Synopsis
This assignment tries to explore the NOAA Storm Database and explore the effects of severe weather events on both population and economy.The database covers the time period between 1950 and November 2011.

The following analysis investigates which types of severe weather events are most harmful on:

a. Health 
b. Property and crops 
...
Download the raw data file and extract the data into a dataframe and then convert it to a data.table
```{r DataLoading}
library("data.table")
library("ggplot2")
