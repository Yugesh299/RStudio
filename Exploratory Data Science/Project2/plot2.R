...
df1 <- df[fips=='24510', lapply(.SD, sum, na.rm = TRUE), .SDcols = c("Emissions"), by = year]
png(filename='plot2.png')
barplot(df1[, Emissions], names = df1[, year], xlab = "Years", ylab = "Emissions", main = "Emissions over the Years")
dev.off()
